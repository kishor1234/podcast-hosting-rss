...
<div class="content-wrapper">
    ...
    <?php
    $response = json_decode($main->jsonRespon(api_url . "/?r=userData", array("userid" => $_SESSION["id"], "postid" => $_REQUEST["id"], "action" => "SinglePostEdit")), true);
    ?>
    <!-- Main content -->
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-10 offset-lg-1 col-sm-12 col-xs-12">
                    ...
                    <div class="card card-gray">
                        <div class="card-header">
                            <h6 class="card-title">Edit Post Podcast</h6>
                        </div>
                        <div class="card-body">
                            <form action="#" method="post" name="registerForm" id="registerForm" enctype="multipart/form-data"> 
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control"  value="<?= $response["title"] ?>" required name="title" id="title" autocomplete="off" title="Podcast profile title" placeholder="Podcast profile title">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea  class="form-control"  required name="description" id="description" autocomplete="off" title="Description" placeholder="Description"><?= $response["description"] ?></textarea>
                                        <div class="input-group-append">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="file"  class="form-control"   name="image" id="image" accept="image/*" capture autocomplete="off" title="Image File for Podcast" placeholder="Image File for Podcast">
                                        <div class="input-group-append">
                                            <span id="error_image">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="<?= $response["image_url"] ?>" alt="" class="thmub">
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-control-label"> Podcast Banner </label>
                                        <input type="file"  class="form-control"   name="banner" id="banner" accept="image/*"  autocomplete="off" title="Banner File for Podcast" placeholder="Banner File for Podcast">
                                        <div class="input-group-append">
                                            <span id="error_image">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="<?= $response["banner_url"] ?>" alt="" class="thmub">
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-control-label"> Podcast Audio File </label>
                                        <input type="file"  class="form-control"   name="file" id="file" accept="audio/*" capture  autocomplete="off" title="Audio File for Podcast" placeholder="Audio File for Podcast">
                                        <div class="input-group-append">
                                            <span id="error_file">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text"  class="form-control"  value="<?= $response["tags"] ?>" required name="tags" id="tags" autocomplete="off" title="Podcast tags" placeholder="Podcast tags">
                                        <div class="input-group-append">
                                            <span id="error_fn">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden"  value="editPodcast" name="action">
                                    <input type="hidden" value="<?= $response["postid"] ?>" name="postid">
                                    <div class="msg">

                                    </div>
                                    <button class="btn btn-primary form-control bg-white">Update PodCast </button>
                                </div>
                            </form>
                        </div>
                    </div>
