                            ...
                            <form action="#" method="post" name="registerForm" id="registerForm" enctype="multipart/form-data"> 
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" value="<?= $response["name"] ?>" class="form-control"  required name="name" id="name" autocomplete="off" title="Enter your full name" placeholder="Enter your full name">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" value="<?= $response["title"] ?>" class="form-control"  required name="title" id="title" autocomplete="off" title="Podcast profile title" placeholder="Podcast profile title">
                                        <div class="input-group-append">
                                            <span id="error_fn">
                                    ...
                                    <div class="col-lg-12">
                                        <label class="form-control-label"> Copyright <span class="text-danger">*</span></label>
                                        <input type="text" value="<?= $response["cp"] ?>" class="form-control"  required name="cp" id="cp" autocomplete="off" title="Enter Copyright" placeholder="Enter copyright">
                                        <div class="input-group-append">
                                            <span id="error_fn">
                                    ...
                                    <div class="col-lg-12">
                                        <label class="form-control-label"> Profile Link <span class="text-danger">*</span></label>
                                        <input type="text" value="<?= $response["link"] ?>" class="form-control"  required name="link" id="link" autocomplete="off" title="Enter your profile link" placeholder="Enter your profile link">
                                        <div class="input-group-append">
                                            <span id="error_fn">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden"  value="updatePersonal" name="action">
                                    <input type="hidden" value="<?= $response["id"] ?>" name="id">
                                    <div class="msg">

                                    </div>
                                    <button class="btn btn-primary form-control bg-white">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
